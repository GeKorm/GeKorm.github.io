...
J.Mp(z)
y=document.querySelector("#tablecon > li:nth-child(2) > a")
x=document.querySelector("#tablecon > li:nth-child(3) > a")
w=J.Vg(y)
v=H.VM(new W.xC(0,w.J6,w.fA,W.VF(null),w.el),[H.Kp(w,0)])
v.DN()
v.fe(new V.em(z))
w=J.Vg(x)
u=H.VM(new W.xC(0,w.J6,w.fA,W.VF(null),w.el),[H.Kp(w,0)])
u.DN()
u.fe(new V.Lb(z))},"$0","eE",0,0,1],
...
J.Ed(document.querySelector("#header").style,"1")}}},1],["","",,P,{
"^":"",
