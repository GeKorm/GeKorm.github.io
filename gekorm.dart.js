...
s.fe(new V.Lb(z,x))
z=J.Vg(v)
r=H.VM(new W.xC(0,z.J6,z.fA,W.VF(null),z.el),[H.Kp(z,0)])
r.DN()
r.fe(new V.QA(y))},"$0","eE",0,0,1],
...
J.Ed(z.style,"0")
J.HT(document.querySelector("#tablewrap").style,"scale(2)")
J.Ed(document.querySelector("#tablewrap").style,"0")
J.HT(document.querySelector("#header").style,"scale(2)")
...
em:{
"^":"Tp:9;b",
$1:function(a){V.OK(1,this.b)},
$isEH:true},
Lb:{
"^":"Tp:9;a,c",
$1:function(a){var z,y
z=document.querySelector("#flexright")
z.toString
if(C.CD.yu(C.CD.UD(z.offsetLeft))<200){z=this.a
y=this.c
if(!z.a){J.pP(y).h(0,"onhover")
z.a=!0}else{J.pP(y).Rz(0,"onhover")
z.a=!1}}},
$isEH:true},
QA:{
"^":"Tp:9;d",
$1:function(a){V.OK(2,this.d)},
$isEH:true},
TY:{
"^":"Tp:7;a,b,c",
...
J.HT(document.querySelector("#tablewrap").style,"scale(1)")
J.Ed(document.querySelector("#tablewrap").style,"1")
J.HT(document.querySelector("#header").style,"scale(1)")
